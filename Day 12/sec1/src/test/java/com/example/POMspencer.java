...
public class POMspencer {
    ...
    public void before() throws Exception{
        ExtentSparkReporter exsprk = new ExtentSparkReporter("D:\\Software Testing\\Day 12\\sec1logandreport\\report1.html");
    ...
    public void test1() throws Exception
    {
        ...
        PropertyConfigurator.configure("D:\\Software Testing\\Day 12\\sec1\\src\\main\\resources\\log4j2.properties");
        FileInputStream fs = new FileInputStream("D:\\Software Testing\\Day 12\\sec1excel.xlsx");
        ...
        poMelements = new POMelements(driver);
        for(int i=0;i<rnum;i++)
        {
            ...
            {
                poMelements.clicksearch(row.getCell(1).getStringCellValue());
    ...
    public void test3() throws Exception{
        ...
        for(int i=0;i<rnum;i++)
        {
            ...
            {
                poMelements.clkmail(row.getCell(1).getStringCellValue());
                row = sheet.getRow(1);
                logger.info("email");
            }
            else if(row.getCell(0).getStringCellValue().equals("pass"))
            {
                poMelements.clkpass(row.getCell(1).getStringCellValue());
                logger.info("pass");
            }
        }
